...
| **CI needs the snapshot-diff step, and it is M1 work** | It is worth more than any test we would write by hand; convention 2 is enforced only once that step runs the diff against a committed snapshot. |
