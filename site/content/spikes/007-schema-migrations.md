...
**Question.** [ADR-0004](/decisions/0004-where-logic-lives) replaced an ordered
...
apply. That is why [ADR-0003](/decisions/0003-migrations) drives migrations from the
...
[ADR-0007](/decisions/0007-schema-conventions-and-chart) already made this argument for
...
`database/sql` dependency [ADR-0001](/decisions/0001-rust-and-postgres) deliberately
