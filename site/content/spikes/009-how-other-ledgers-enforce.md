...
**Question.** [ADR-0004](/decisions/0004-where-logic-lives) removed 19 of 27 triggers on
...
line, and it is the one [ADR-0005](/decisions/0005-event-log-and-write-path) now follows.
...
**This corrects our own [spike 001](/spikes/001-formance)**, which concluded the trigger cascade
...
[ADR-0004](/decisions/0004-where-logic-lives) is about.
