...
function DrawerContent({
  ...
  /**
   * Keep the popup in the DOM while it is closed, so whatever it holds keeps
   * its state between openings. Forwarded to the portal; the shadcn original
   * has no way to reach it, and a form that forgot what you typed the moment
   * you closed its drawer would be a worse composer than the one it replaced.
   */
  keepMounted?: boolean
}) {
