...
**Status:** closed. Produced [ADR-0009](../../docs/decisions/0009-module-boundaries.md).

**Question.** [ADR-0002](../../docs/decisions/0002-scaling.md) calls the card product a plug-in whose
entire coupling to the ledger core is one read. [ADR-0003](../../docs/decisions/0003-migrations.md)
...
**(b) A migration set per module — works, and I would still not take it.** [`core_mig.sql`](./core_mig.sql)
(725 lines) and [`card_mig.sql`](./card_mig.sql) (471) applied in order produce a `pg_dump -s`
...
[spike 007](../007-schema-migrations/README.md) and carried into an `sqlx` decision without being
