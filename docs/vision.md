...
[README](../README.md) shows one $500 card purchase in full. The part that surprises everyone is
...
days later, possibly for a different amount, possibly never. The [glossary](./glossary.md) has the
...
updating a row takes a lock. [Spike 003](../spikes/003-throughput-ceiling/README.md) measured that
