...
- **The effective-axis aggregate is linear and currently unbounded** — roughly 0.22 µs per entry
  in range, extrapolating to ~220 ms at 1M entries and ~2.2 s at 10M. We have traded Formance's
